library rounded_checkbox_list_tile;
...
class RoundedCheckboxListTile extends StatelessWidget {
  ...
  const RoundedCheckboxListTile({
    ...
    this.checkboxEdgeRadius = const Radius.circular(1.0)
  }) : assert(value != null),
  ...
  final Radius checkboxEdgeRadius;
  ...
  @override
  Widget build(BuildContext context) {
    final Widget control = RoundedCheckbox(
      value: value,
      onChanged: onChanged,
      activeColor: activeColor,
      checkColor: checkColor,
      materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
      edgeRadius: checkboxEdgeRadius,
    );
